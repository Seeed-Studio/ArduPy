...
mkdir -p  ${work_pwd}/deploy/Seeeduino/tools/seeeduino_m0 
mv  ${work_pwd}/deploy/Seeeduino/tools/genhdr/* ${work_pwd}/deploy/Seeeduino/tools/seeeduino_m0 
mv ${work_pwd}/deploy/Seeeduino/tools/seeeduino_m0  ${work_pwd}/deploy/Seeeduino/tools/genhdr
...
mkdir -p ${work_pwd}/deploy/Seeeduino/tools/genhdr/wio_terminal
