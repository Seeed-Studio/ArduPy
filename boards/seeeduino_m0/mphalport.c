...
uint32_t mp_hal_ticks_ms(void) { return micros(); }
...
void flash_read(const volatile void *flash_ptr, void *data, uint32_t size) { memcpy(data, (const void *)flash_ptr, size); }
